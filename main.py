...
bot = Client(
    "bot",
    bot_token=os.environ.get("5994063715:AAG5TpTgHBJIUTHzTf03qGqShpGnUfsrP5U"),
    api_id=int(os.environ.get("23161785")),
    api_hash=os.environ.get("72e2c9ff7f587a134a46fe99708e3194")
)
